...
public class GuideController implements Execute {
	...
	public Result execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServerException {
		...
		/* req.setAttribute("guides", adminDAO.guide()); */
...
//		한 페이지에서 나오는 페이지 버튼의 개수
		...
		req.setAttribute("guides", adminDAO.guide(pageMap));
		...
		result.setPath("/app/admin/guide.jsp");
